...
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "egress_limit_bytes" bigint;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "lock_reason" text;--> statement-breakpoint
DO $$ BEGIN

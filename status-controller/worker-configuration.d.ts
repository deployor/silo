/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=.dev.vars.example --strict-vars=false` (hash: 8ea4360ef498051c00799e77a7cc11fe)
// Runtime types generated with workerd@1.20260714.1 2026-07-17 nodejs_compat_v2
interface __BaseEnv_Env {
	DB: D1Database;
	DATABASE_EU: Hyperdrive;
	DATABASE_US: Hyperdrive;
	REGION_REGISTRY: string;
	DASHBOARD_HEALTH_URL: string;
	MAINTENANCE_URL: string;
	DASHBOARD_DNS_NAME: string;
	CONTROL_PLANE_ORIGIN_HOST: string;
	STATUS_ADMIN_ORIGINS: string;
	AUTO_ACTIVATE_FAILOVER: string;
	AUTO_PROMOTE_STORAGE: string;
	...
	REGION_CANARIES: string;
	CF_DNS_TOKEN: string;
	CF_ZONE_ID: string;
	CF_ENDPOINT_RECORD_IDS: string;
	CF_DASHBOARD_RECORD_ID: string;
	STATUS_ADMIN_SECRET: string;
	STATUS_INCIDENT_PASSWORD: string;
	ALERT_WEBHOOK_URL: string;
	CLOUDFLARE_API_BASE: string;
	FAILOVER_ACTIVATION_URLS: string;
	FAILOVER_DEACTIVATION_URLS: string;
	FAILOVER_HOOK_SECRET: string;
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=.dev.vars.example --strict-vars=false` (hash: 70509604869a49ee87c0e84771d9f46b)

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=.dev.vars.example --strict-vars=false` (hash: 4ad19d731b1f1e72db408a641a3d42ce)
